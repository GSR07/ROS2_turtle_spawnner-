...
from rob_interfaces.msg import Turtle
from rob_interfaces.msg import TurtleArray
from rob_interfaces.srv import CatchTurtleKill
...
class TurtleControllerNode(Node):
    def __init__(self):
        ...
        self.catch_turtle_client_ = self.create_client(CatchTurtleKill, "catch_turtle")
    ...
    def call_catch_turtle_service(self, turtle_name):
        ...
        request = CatchTurtleKill.Request()
    ...
    def callback_call_catch_turtle_service(self, future, turtle_name):
        response: CatchTurtleKill.Response = future.result()
